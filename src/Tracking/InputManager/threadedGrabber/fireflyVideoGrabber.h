...
public:
    ...
    //TODO: Guti changed this
	void setShutterNorm(float curShutter){
		vidGrabber.lock();
		vidGrabber.setShutter(curShutter);
		vidGrabber.unlock();
	}
	void setGainNorm(float curGain){		
		vidGrabber.lock();
		vidGrabber.setGain(curGain);
		vidGrabber.unlock();
	}
	void setBrightnessNorm(float curBrightness){
		vidGrabber.lock();
		vidGrabber.setBrightness(curBrightness);
		vidGrabber.unlock();
	}
	void setExposureNorm(float curExposure){
		vidGrabber.lock();
		vidGrabber.setExposure(curExposure);
		vidGrabber.unlock();
	}
	void setGammaNorm(float curGamma){
		vidGrabber.lock();
		vidGrabber.setGamma(curGamma);
		vidGrabber.unlock();
	}
	...
	void frameReceived(ofxLibdc::PointGrey& grabber){
